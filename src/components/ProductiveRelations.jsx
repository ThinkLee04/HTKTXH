        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          <div className="mt-32 space-y-20">
            ...
            <motion.div
              ...
              className="text-center"
            >
              <h3 className="text-4xl md:text-5xl font-bold text-amber-200 mb-6">
                Quy luật vòng lặp phát triển
              </h3>
            ...
            >
              <div className="text-center">
                <h4 className="text-3xl font-bold text-amber-200 mb-4">
                  Áp dụng thực tiễn
                </h4>
                <p className="text-lg text-amber-100/80 max-w-3xl mx-auto">
                  Sau khi hiểu được mối quan hệ biện chứng giữa LLSX và QHSX, 
                  áp dụng vào thực tiễn sẽ giúp xã hội phát triển:
                </p>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                
                {/* Upgrade Vehicle - LLSX */}
                <motion.div
                  initial={{ opacity: 0, x: -50 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.8, delay: 0.2 }}
                  className="bg-gradient-to-br from-amber-900/50 to-orange-900/50 backdrop-blur-sm border border-amber-600/50 rounded-3xl p-8"
                >
                  <div className="text-center mb-6">
                    <motion.div
                      animate={{ rotate: [0, 5, -5, 0] }}
                    ...
                    <h5 className="text-2xl font-bold text-amber-200">Nâng cấp 'Chiếc xe' LLSX</h5>
                  </div>

                  <div className="space-y-6">
                    <div className="bg-amber-800/30 rounded-2xl p-6 border border-amber-600/30">
                      <div className="flex items-start gap-4">
                        <div className="text-3xl">👨‍🎓</div>
                        <div>
                          <h6 className="font-bold text-amber-200 mb-2">Đầu tư vào 'Người lái'</h6>
                          <p className="text-amber-100/90 text-sm leading-relaxed">
                            Phát triển <span className="text-amber-300 font-semibold">giáo dục</span>, 
                            nâng cao chất lượng <span className="text-amber-300 font-semibold">nguồn nhân lực</span>. 
                            Đào tạo kỹ năng cho kỷ nguyên số.
                          </p>
                        </div>
                      </div>
                    </div>

                    <div className="bg-orange-800/30 rounded-2xl p-6 border border-orange-600/30">
                      <div className="flex items-start gap-4">
                        <div className="text-3xl">⚙️</div>
                        <div>
                          <h6 className="font-bold text-orange-200 mb-2">Đầu tư vào 'Động cơ'</h6>
                          <p className="text-orange-100/90 text-sm leading-relaxed">
                            Đẩy mạnh <span className="text-orange-300 font-semibold">cách mạng công nghiệp 4.0</span>, 
                            ứng dụng <span className="text-orange-300 font-semibold">khoa học công nghệ</span>. 
                            AI, IoT, Blockchain trong sản xuất.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.8, delay: 0.4 }}
                  className="bg-gradient-to-br from-stone-800/50 to-stone-900/50 backdrop-blur-sm border border-stone-600/50 rounded-3xl p-8"
                >
                  <div className="text-center mb-6">
                    <motion.div
                      animate={{ scale: [1, 1.1, 1] }}
                    ...
                    <h5 className="text-2xl font-bold text-stone-200">Nâng cấp 'Hệ thống đường' QHSX</h5>
                  </div>

                  <div className="space-y-6">
                    <div className="bg-stone-700/30 rounded-2xl p-6 border border-stone-600/30">
                      <div className="flex items-start gap-4">
                        <div className="text-3xl">⚖️</div>
                        <div>
                          <h6 className="font-bold text-stone-200 mb-2">Cải cách thể chế</h6>
                          <p className="text-stone-200/90 text-sm leading-relaxed">
                            Xây dựng <span className="text-stone-300 font-semibold">luật pháp hiện đại</span>, 
                            <span className="text-stone-300 font-semibold">chính sách linh hoạt</span>. 
                    ...
                    <div className="bg-stone-700/30 rounded-2xl p-6 border border-stone-600/30">
                      <div className="flex items-start gap-4">
                        <div className="text-3xl">🏗️</div>
                        <div>
                          <h6 className="font-bold text-stone-200 mb-2">Phát triển hạ tầng</h6>
                          <p className="text-stone-200/90 text-sm leading-relaxed">
                            Xây dựng <span className="text-stone-300 font-semibold">hạ tầng thông minh</span>, 
                            <span className="text-stone-300 font-semibold">hệ thống logistics hiện đại</span>. 
                            5G, smart city, e-government.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.8, delay: 0.6 }}
                className="text-center bg-gradient-to-br from-amber-900/30 to-orange-900/30 backdrop-blur-sm border border-amber-500/30 rounded-3xl p-8 max-w-4xl mx-auto"
              >
                <motion.div
                ...
                <h5 className="text-2xl font-bold text-amber-200 mb-4">
                  Kết luận: Sự phát triển bền vững
                </h5>
                <p className="text-lg text-amber-100/90 leading-relaxed">
                  Chỉ khi <span className="text-amber-300 font-semibold">LLSX</span> và 
                  <span className="text-orange-300 font-semibold"> QHSX</span> phát triển 
                  <span className="text-amber-300 font-semibold"> đồng bộ</span>, xã hội mới có thể 
                  tiến lên một cách <span className="text-orange-300 font-semibold">bền vững</span> và 
                  <span className="text-amber-300 font-semibold">thịnh vượng</span>! 🌟
                </p>
              </motion.div>
            </motion.div>
          </div>
